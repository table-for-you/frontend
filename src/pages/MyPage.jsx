                ...
                <div>
                    <div className="flex flex-col gap-4">
                        ...
                        <div>
                            ...
                            <Button
                                className={`${tomatoBtn} cursor-pointer disabled:opacity-50 float-right mt-2`}
                                disabled={
                                    isSubmitting ||
                                    (!errors.nickname && valNickname === null && watch("nickname")) ||
                                    (!errors.nickname && valNickname === true) ||
                        ...
                        <div>
                            <p className="font-bold mb-2">비밀번호 변경</p>
                            <form
                                className="bg-neutral-100 shadow-lg p-4 flex flex-col gap-3"
                            ...
                            >
                                ...
                                />
                                <Button
                                    onClick={checkCurrentPass}
                                >
                                    확인하기
                                </Button>
                                {(currentPassCheck === null) && (
                                    <small className="text-red-500">현재 비밀번호를 확인해주세요.</small>
                                )}
                                {(currentPassCheck === false) && (
                                    <small className="text-red-500">현재 비밀번호와 일치하지 않습니다.</small>
                                )}
